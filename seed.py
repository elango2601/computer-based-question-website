...
def seed():
    ...
    tests_data = [
        ("Maths Part 1 (Matrices)", "Unit 1: Applications of Matrices and Determinants", yesterday),
        ("Maths Part 2 (Complex Numbers)", "Unit 2: Complex Numbers", today),
        ("Maths Part 3 (Theory of Equations)", "Unit 3: Theory of Equations", tomorrow),
        ("Maths Part 4 (Inv. Trigonometry)", "Unit 4: Inverse Trigonometric Functions", tomorrow + datetime.timedelta(days=1))
    ]
    ...
    questions_list = [
        ...
        # Unit 3 - Theory of Equations (Part 3)
        {
        ...
        # Unit 4 - Inv. Trigonometry (Part 4)
        {
